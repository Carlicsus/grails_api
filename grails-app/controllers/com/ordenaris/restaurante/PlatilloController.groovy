...
class PlatilloController {
    ...
    def nuevoPlatillo(){
        ...
        // println "-----------"
        // println data.nombre
        // println data.menuTipo 
        // println fechaDisponible
        // println data.costo.toInteger()
        // println data.descripcion
        // println platillosDisponibles
        // println "-----------"
        // println data.nombre.getClass()
        // println data.menuTipo.getClass()
        // println fechaDisponible.getClass()
        // println data.costo.toInteger().getClass()
        // println data.descripcion.getClass()
        // println platillosDisponibles.toInteger().getClass()
